...
public class OutgoingFragment extends Fragment {
    private static final String TAG = "OUTGOING_FRAGMENT";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new ProviderCallHistoryAdapter(reviews, activity,true);
    ...
    public class GetCallHistory extends AsyncTask<Void, Void, CallHistoryResponse> {
        ...
        protected CallHistoryResponse doInBackground(Void... voids) {
            try {
                ...
                // Make the API call
                Call<CallHistoryResponse> call = apiInterface.getCallHistoryProviderOutGoing(
