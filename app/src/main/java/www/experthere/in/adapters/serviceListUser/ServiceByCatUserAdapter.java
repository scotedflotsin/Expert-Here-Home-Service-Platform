...
public class ServiceByCatUserAdapter extends RecyclerView.Adapter<ServiceByCatUserAdapter.ViewHolder> {

    List<Service> services;
    Activity activity;
    FragmentManager fragmentManager;

    public ServiceByCatUserAdapter(List<Service> services, Activity activity,FragmentManager fragmentManager) {
    ...
    @NonNull
    @Override
    public ServiceByCatUserAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ServiceByCatUserAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.itemClickBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ServiceDetailsBottomSheet bottomSheet = new ServiceDetailsBottomSheet(services.get(position),activity,true);
